...
import { StatsCards } from '~/components/dashboard-old/stats-cards';
import { SalesOverview } from '~/components/dashboard-old/sales-overview';
import { PricingStrategy } from '~/components/dashboard-old/pricing-strategy';
import { AIInsights } from '~/components/dashboard-old/ai-insights';
import { PriceComparison } from '~/components/dashboard-old/price-comparison';
import { ProductMatching } from '~/components/dashboard-old/product-matching';
